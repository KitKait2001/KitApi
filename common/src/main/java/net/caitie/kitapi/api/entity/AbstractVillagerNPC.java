...
import net.caitie.kitapi.api.entity.ai.navigation.NPCMoveControl;
import net.caitie.kitapi.api.entity.inventory.NPCInventory;
...
public abstract class AbstractVillagerNPC extends AbstractVillager implements IKitNPC {
    ...
    @Override
    public AbstractVillagerNPC entity() {
        return this;
    }
