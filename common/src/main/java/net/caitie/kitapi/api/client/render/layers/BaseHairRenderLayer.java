...
public abstract class BaseHairRenderLayer<T extends LivingEntity, M extends EntityModel<T>> extends GeneticsRenderLayer<T, M> {

    public BaseHairRenderLayer(RenderLayerParent<T, M> pRenderer) {
        super(pRenderer);
    }
